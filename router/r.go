...
func BuildInit() {
	if IsRouter() {
		...
		gs.Str("/usr/sbin/lcd-btn.py").Println("Clear").Rm()
		gs.Str("/usr/sbin/redsocks2").Println("Clear").Rm()
		// gs.Str("/etc/init.d/proxy-z").Println("Clear").Rm()
		// gs.Str("/etc/rc.d/S96proxy-z").Println("Clear").Rm()
		// gs.Str("/usr/local/bin/proxy-z").Println("Clear").Rm()
		// gs.Str("/usr/sbin/auto-proxy-z").Println("Clear").Rm()
		ReleaseRedsocks()
