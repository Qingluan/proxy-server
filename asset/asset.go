...
func resourcesPemCertPem() (*asset, error) {
	...
	info := bindataFileInfo{name: "Resources/pem/cert.pem", size: 2155, mode: os.FileMode(420), modTime: time.Unix(1721719132, 0)}
...
func resourcesPemKeyPem() (*asset, error) {
	...
	info := bindataFileInfo{name: "Resources/pem/key.pem", size: 3243, mode: os.FileMode(420), modTime: time.Unix(1721719132, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
